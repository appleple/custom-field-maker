...
function makerReducer() {
  ...
  switch (action.type) {
    ...
    case 'UNDO':
      {
        var _action$payload;
        const target = ((_action$payload = action.payload) === null || _action$payload === void 0 ? void 0 : _action$payload.target) || 'customfield';
    ...
    case 'REDO':
      {
        ...
        const target = ((_action$payload2 = action.payload) === null || _action$payload2 === void 0 ? void 0 : _action$payload2.target) || 'customfield';
