...
var _add_column = require('../assets/images/add_column.svg');

var _add_column2 = _interopRequireDefault(_add_column);

var _add_row = require('../assets/images/add_row.svg');

var _add_row2 = _interopRequireDefault(_add_row);
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              (mode === 'normal' || mode === 'group') && _react2.default.createElement(
                'div',
                { className: 'acms-admin-form-checkbox' },
              ...
              (mode === 'group' || mode === 'unit-group') && _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    'label',
                    { htmlFor: 'direction-horizontal', className: (0, _classnames2.default)("customFieldDirectionBtn", {
                        "active": direction === 'horizontal'
                      }), 'data-tip': true, 'data-for': 'group-field-direction-horizontal' },
                    _react2.default.createElement('input', { type: 'radio', id: 'direction-horizontal',
                      onChange: function onChange() {
                        actions.changeDirection('horizontal');
                      }, checked: direction === 'horizontal' }),
                    _react2.default.createElement('img', { src: _add_column2.default })
                  ),
                  _react2.default.createElement(
                    'label',
                    { htmlFor: 'direction-vertical', className: (0, _classnames2.default)("customFieldDirectionBtn", {
                        "active": direction === 'vertical'
                      }), 'data-tip': true, 'data-for': 'group-field-direction-vertical' },
                    _react2.default.createElement('input', { type: 'radio', id: 'direction-vertical',
                      onChange: function onChange() {
                        actions.changeDirection('vertical');
                      }, checked: direction === 'vertical' }),
                    _react2.default.createElement('img', { src: _add_row2.default })
                  )
                ),
                _react2.default.createElement(
                  _reactTooltip2.default,
                  { id: 'group-field-direction-vertical', place: 'top', type: 'dark', effect: 'solid', className: 'acms-admin-tooltip acms-tooltip customFieldTooltip' },
                  _react2.default.createElement(
                    'span',
                    null,
                ...
                _react2.default.createElement(
                  _reactTooltip2.default,
                  { id: 'group-field-direction-horizontal', place: 'top', type: 'dark', effect: 'solid', className: 'acms-admin-tooltip acms-tooltip customFieldTooltip' },
                  _react2.default.createElement(
                    'span',
                    null,
