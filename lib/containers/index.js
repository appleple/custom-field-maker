...
function CustomFieldMaker() {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    'customfield': /*#__PURE__*/_react.default.createElement(_FieldSource.FieldSource, null),
    'fieldgroup': /*#__PURE__*/_react.default.createElement(_FieldGroupSource.FieldGroupSource, null),
    'customunit': /*#__PURE__*/_react.default.createElement(_UnitSource.UnitSource, null),
    'unitgroup': /*#__PURE__*/_react.default.createElement(_UnitGroupSource.UnitGroupSource, null)
  }[preview.mode] || null)), preview.editMode === 'preview' && /*#__PURE__*/_react.default.createElement("div", {
    style: {
      borderRadius: '5px',
      padding: '20px',
      margin: '1em 0',
    ...
    'customunit': /*#__PURE__*/_react.default.createElement(_UnitSource.UnitSource, null),
    'unitgroup': /*#__PURE__*/_react.default.createElement(_UnitGroupSource.UnitGroupSource, null)
  }[preview.mode] || null), preview.editMode === 'confirm' && /*#__PURE__*/_react.default.createElement(_Highlighter.Highlighter, {
    onHighlight: onSource
  }, /*#__PURE__*/_react.default.createElement(_MakerContext.MakerContextProvider, {
    state: state,
    preview: preview,
    ...
    'customfield': /*#__PURE__*/_react.default.createElement(_FieldConfirmSource.FieldConfirmSource, null),
    'fieldgroup': /*#__PURE__*/_react.default.createElement(_FieldGroupConfirmSource.FieldGroupConfirmSource, null),
    'customunit': /*#__PURE__*/_react.default.createElement(_UnitConfirmSource.UnitConfirmSource, null),
    'unitgroup': /*#__PURE__*/_react.default.createElement(_UnitGroupConfirmSource.UnitGroupConfirmSource, null)
  }[preview.mode] || null))))))));
}
