    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'ul',
            { className: 'js-acms_tabs' },
            _react2.default.createElement(
              'li',
              null,
              _react2.default.createElement(
                'a',
                { href: '#source', className: (0, _classnames2.default)({ 'js-acms_tab-active': editMode === 'source' }), onClick: this.updateState.bind(this, 'editMode', 'source') },
                '\u5165\u529B\u7528\u30BD\u30FC\u30B9'
              )
            ),
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                'a',
                { href: '#preview', className: (0, _classnames2.default)({ 'js-acms_tab-active': editMode === 'preview' }), onClick: this.updateState.bind(this, 'editMode', 'preview') },
                '\u30D7\u30EC\u30D3\u30E5\u30FC'
              )
            ),
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                'a',
                { href: '#confirm', className: (0, _classnames2.default)({ 'js-acms_tab-active': editMode === 'confirm' }), onClick: this.updateState.bind(this, 'editMode', 'confirm') },
                '\u51FA\u529B\u7528\u30BD\u30FC\u30B9'
              )
            )
          ),
          _react2.default.createElement(
            ...
            editMode === 'source' && _react2.default.createElement(
              ...
              mode === 'normal' && _react2.default.createElement(_fieldSource2.default, { customfield: customfield, acmscss: acmscss }),
              mode === 'group' && _react2.default.createElement(_fieldGroupSource2.default, { groupitems: groupitems, acmscss: acmscss, groupTitle: groupTitle, groupName: groupName }),
              mode === 'unit' && _react2.default.createElement(_unitSource2.default, { customunit: customunit, acmscss: acmscss }),
              mode === 'unit-group' && _react2.default.createElement(_unitGroupSource2.default, { unitgroupitems: unitgroupitems, acmscss: acmscss, unitGroupTitle: unitGroupTitle, unitGroupName: unitGroupName })
            ),
            editMode === 'preview' && _react2.default.createElement(
              'div',
              ...
              mode === 'group' && _react2.default.createElement(_fieldGroupSource2.default, { groupitems: groupitems, acmscss: acmscss, groupTitle: groupTitle, groupName: groupName, preview: true }),
              mode === 'unit' && _react2.default.createElement(_unitSource2.default, { customunit: customunit, acmscss: acmscss, preview: true }),
              mode === 'unit-group' && _react2.default.createElement(_unitGroupSource2.default, { unitgroupitems: unitgroupitems, acmscss: acmscss, unitGroupTitle: unitGroupTitle, unitGroupName: unitGroupName, preview: true })
            ),
            editMode === 'confirm' && _react2.default.createElement(
              ...
              mode === 'group' && _react2.default.createElement(_fieldGroupConfirmSource2.default, { groupitems: groupitems, acmscss: acmscss, groupTitle: groupTitle, groupName: groupName }),
              mode === 'unit' && _react2.default.createElement(_unitConfirmSource2.default, { customunit: customunit, acmscss: acmscss }),
              mode === 'unit-group' && _react2.default.createElement(_unitGroupConfirmSource2.default, { unitgroupitems: unitgroupitems, acmscss: acmscss, unitGroupTitle: unitGroupTitle, unitGroupName: unitGroupName })
            )
          )
        )
      );
