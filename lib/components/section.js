...
var Section = exports.default = /*#__PURE__*/function (_Component) {
  ...
  return (0, _createClass2.default)(Section, [{
    ...
    value: function getLabel(item) {
      ...
      return /*#__PURE__*/_react.default.createElement(_react.Fragment, null, item.title, item.tooltip && /*#__PURE__*/_react.default.createElement("i", {
    ...
    value: function renderLabel(item) {
      return /*#__PURE__*/_react.default.createElement(_react.Fragment, null, item.type === 'checkbox' || item.type === 'radio' ? /*#__PURE__*/_react.default.createElement("legend", null, this.getLabel(item)) : /*#__PURE__*/_react.default.createElement("label", null, this.getLabel(item)));
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return /*#__PURE__*/_react.default.createElement(_react.Fragment, null, jsValidator && '<!-- <form action="" method="post" class="js-validator" enctype="multipart/form-data"> -->', customfield && customfield.map(function (item, index) {
        if (item.type === 'text') {
          return /*#__PURE__*/_react.default.createElement("p", {
            key: index
          }, _this.renderLabel(item, acmscss, jsValidator), /*#__PURE__*/_react.default.createElement("span", null, /*#__PURE__*/_react.default.createElement("input", (0, _extends2.default)({
            type: "text",
            name: item.name,
          ...
          return /*#__PURE__*/_react.default.createElement("p", {
            key: index
          }, _this.renderLabel(item, acmscss), /*#__PURE__*/_react.default.createElement("span", null, /*#__PURE__*/_react.default.createElement("textarea", (0, _extends2.default)({
            name: item.name,
            className: (0, _classnames.default)({
              'acms-admin-form-width-full': acmscss
            })
          ...
          return /*#__PURE__*/_react.default.createElement("p", {
            key: index
          }, _this.renderLabel(item, acmscss), /*#__PURE__*/_react.default.createElement("span", null, /*#__PURE__*/_react.default.createElement(ConditionalWrap, {
          ...
          return /*#__PURE__*/_react.default.createElement("p", {
            key: index
          }, _this.renderLabel(item, acmscss), /*#__PURE__*/_react.default.createElement("span", null, /*#__PURE__*/_react.default.createElement("div", {
          ...
          return /*#__PURE__*/_react.default.createElement("p", {
            key: index
          }, _this.renderLabel(item, acmscss), /*#__PURE__*/_react.default.createElement("span", null, /*#__PURE__*/_react.default.createElement("select", {
            name: item.name,
            className: (0, _classnames.default)({
              'acms-admin-form-width-full': acmscss
            })
          ...
          return /*#__PURE__*/_react.default.createElement("p", {
            key: index
          }, _this.renderLabel(item), /*#__PURE__*/_react.default.createElement("span", null, item.option.map(function (option) {
            if (!option.label) {
              return null;
            }
            return /*#__PURE__*/_react.default.createElement("div", {
          ...
          return /*#__PURE__*/_react.default.createElement("p", {
          ...
          }, preview ? null : "<!-- BEGIN_IF [{".concat(item.name, "@path}/nem] -->"), /*#__PURE__*/_react.default.createElement(_react.Fragment, null, /*#__PURE__*/_react.default.createElement("img", {
            ...
            className: "acms-admin-ico-checkbox"
          }), "\u524A\u9664")), preview ? null : '<!-- ELSE -->', /*#__PURE__*/_react.default.createElement(_react.Fragment, null, /*#__PURE__*/_react.default.createElement("img", {
            src: "%{ARCHIVES_DIR}{".concat(item.name, "@path}"),
            className: (0, _classnames.default)({
              'acms-admin-img-responsive': acmscss,
              'js-img_resize_preview': item.resize
          ...
          return /*#__PURE__*/_react.default.createElement("p", {
            key: index
          }, _this.renderLabel(item, acmscss), /*#__PURE__*/_react.default.createElement("span", null, preview ? null : "<!-- BEGIN ".concat(item.name, "@path:veil -->"), /*#__PURE__*/_react.default.createElement("input", {
            type: "hidden",
            name: "".concat(item.name, "@old"),
            value: "{".concat(item.name, "@path}")
          }), /*#__PURE__*/_react.default.createElement("input", {
            ...
            height: "64",
            alt: alt
          })), preview ? null : "<!-- END ".concat(item.name, "@path:veil -->"), /*#__PURE__*/_react.default.createElement("input", {
            type: "file",
            name: item.name
          }), /*#__PURE__*/_react.default.createElement("input", {
            type: "hidden",
