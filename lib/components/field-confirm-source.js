    ...
    value: function render() {
      ...
      return _react["default"].createElement("table", {
        ...
        if (item.type === 'text') {
          ...
          return _react["default"].createElement("tr", {
            key: index
          }, _react["default"].createElement("th", null, item.title), _react["default"].createElement("td", null, item.mediaType !== 'file' && _react["default"].createElement(_react.Fragment, null, "<!-- BEGIN_IF [{".concat(item.name, "@link}/nem] -->"), _react["default"].createElement("a", {
