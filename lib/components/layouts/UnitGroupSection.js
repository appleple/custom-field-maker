...
exports.UnitGroupSection = void 0;
...
const UnitGroupSection = exports.UnitGroupSection = /*#__PURE__*/(0, _react.forwardRef)((_props, ref) => {
  const {
    state: {
      unitgroup
    },
  ...
  const renderTemplateComponent = /*#__PURE__*/_react.default.createElement("div", {
  ...
  }, unitgroup.items.map((item, index) => /*#__PURE__*/_react.default.createElement("div", {
    key: index,
    className: (0, _classnames.default)({
      'acms-admin-flex': acmscss,
      'acms-admin-flex-col-max-md': acmscss,
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, unitgroup.name && unitgroup.title && /*#__PURE__*/_react.default.createElement("section", {
    ref: ref
  }, unitgroup.title && /*#__PURE__*/_react.default.createElement("h2", {
    className: (0, _classnames.default)({
      'acms-admin-admin-title2': acmscss
    })
  }, unitgroup.title), unitgroup.name && /*#__PURE__*/_react.default.createElement("div", {
    className: (0, _classnames.default)({
      'js-fieldgroup-sortable': true,
      'acms-admin-grid-edit-table': acmscss
    })
  }, editMode === 'preview' ? null : unitgroup.items.length > 0 && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, editMode === 'preview' ? null : "<!-- BEGIN ".concat(unitgroup.name, ":loop -->"), /*#__PURE__*/_react.default.createElement("div", {
    className: (0, _classnames.default)({
      'sortable-item': true,
      'acms-admin-flex': acmscss,
      'acms-admin-flex-col-max-md': acmscss,
    ...
    className: "item-delete acms-admin-btn-admin acms-admin-btn-admin-danger",
    value: "\u524A\u9664"
  }, "\u524A\u9664"))), "<!-- END ".concat(unitgroup.name, ":loop -->")), unitgroup.items.length > 0 && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, editMode === 'preview' ? /*#__PURE__*/_react.default.createElement("div", {
    className: "item-template"
  }, renderTemplateComponent()) : /*#__PURE__*/_react.default.createElement("template", {
    className: "item-template"
  }, renderTemplateComponent()), /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("input", {
    type: "button",
    className: "item-insert acms-admin-btn-admin",
    value: "\u8FFD\u52A0"
  })))), unitgroup.name && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, unitgroup.items.map(item => /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, item.type === 'image' && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, item.square && item.squareSize && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("input", {
    type: "hidden",
  ...
  })), item.large && item.largeSize && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("input", {
    type: "hidden",
    name: "@".concat(unitgroup.name, "{id}[]"),
  ...
  })), item.tiny && item.tinySize && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("input", {
    type: "hidden",
    name: "@".concat(unitgroup.name, "{id}[]"),
    ...
    value: "{".concat(item.name, "{id}@fileSize}")
  }), /*#__PURE__*/_react.default.createElement("input", {
    type: "hidden",
    name: "@".concat(item.name, "{id}[]"),
    value: "{".concat(item.name, "{id}@baseName}")
  }), /*#__PURE__*/_react.default.createElement("input", {
    type: "hidden",
    name: "@".concat(item.name, "{id}[]"),
    value: "{".concat(item.name, "{id}@originalName}")
  }), /*#__PURE__*/_react.default.createElement("input", {
    type: "hidden",
    name: "@".concat(unitgroup.name, "{id}[]"),
    value: "".concat(item.name, "{id}@alt")
    ...
    name: "".concat(item.name, "{id}:extension"),
    value: "file"
  })), item.type === 'media' && /*#__PURE__*/_react.default.createElement("input", {
    type: "hidden",
    name: "".concat(item.name, "{id}:extension"),
    value: "media"
  }), item.type === 'richEditor' && /*#__PURE__*/_react.default.createElement("input", {
    type: "hidden",
    name: "".concat(item.name, "{id}:extension"),
    value: "rich-editor"
  }), /*#__PURE__*/_react.default.createElement("input", {
