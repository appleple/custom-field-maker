...
exports.GroupTableLayout = void 0;
...
const GroupTableLayout = exports.GroupTableLayout = /*#__PURE__*/(0, _react.forwardRef)((_props, ref) => {
  const {
    state: {
      fieldgroup
    },
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, fieldgroup.title && /*#__PURE__*/_react.default.createElement("h2", {
    className: (0, _classnames.default)({
      'acms-admin-admin-title2': acmscss
    })
  }, fieldgroup.title), fieldgroup.name && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("table", {
    className: (0, _classnames.default)('js-fieldgroup-sortable', {
      'adminTable acms-admin-table-admin-edit': acmscss
    }),
    ref: ref
  }, editMode === 'preview' ? null : fieldgroup.items.length > 0 && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("thead", {
    className: (0, _classnames.default)({
  ...
  }, "\xA0"), direction === 'horizontal' && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, fieldgroup && fieldgroup.items.map((item, index) => /*#__PURE__*/_react.default.createElement("th", {
    key: index,
    className: (0, _classnames.default)({
  ...
  }, "\u524A\u9664"))), /*#__PURE__*/_react.default.createElement("tbody", null, editMode === 'preview' ? null : "<!-- BEGIN ".concat(fieldgroup.name, ":loop -->"), /*#__PURE__*/_react.default.createElement("tr", {
  ...
  })), /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, fieldgroup.items.map((item, index) => {
    switch (item.type) {
      case 'text':
      case 'tel':
      case 'number':
      ...
      case 'richEditor':
        {
          return /*#__PURE__*/_react.default.createElement(_WrapTable.WrapTable, {
            title: item.title
          }, /*#__PURE__*/_react.default.createElement("td", null, /*#__PURE__*/_react.default.createElement(ConditionalWrap, {
            condition: item.useExpand,
            wrap: children => /*#__PURE__*/_react.default.createElement("div", {
  ...
  }, "\u524A\u9664"))), editMode === 'preview' ? null : "<!-- END ".concat(fieldgroup.name, ":loop -->"), editMode === 'preview' ? null : /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("tr", {
  ...
  }, "\u524A\u9664"))))), /*#__PURE__*/_react.default.createElement("tfoot", null, /*#__PURE__*/_react.default.createElement("tr", null, /*#__PURE__*/_react.default.createElement("td", {
    ...
    value: "\u8FFD\u52A0"
  }))))))), fieldgroup.name && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, fieldgroup.items.map(item => /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, item.type === 'image' && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, item.square && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("input", {
    type: "hidden",
    ...
    type: "hidden",
    name: "@".concat(fieldgroup.name, "[]"),
    value: "{".concat(item.name, "@originalName}")
  }), /*#__PURE__*/_react.default.createElement("input", {
    type: "hidden",
    name: "@".concat(fieldgroup.name, "[]"),
    value: "".concat(item.name, "@alt")
    ...
    name: "".concat(item.name, ":extension"),
    value: "media"
  }), item.type === 'rich-editor' && /*#__PURE__*/_react.default.createElement("input", {
    type: "hidden",
    name: "".concat(item.name, ":extension"),
    value: "rich-editor"
  }), /*#__PURE__*/_react.default.createElement("input", {
