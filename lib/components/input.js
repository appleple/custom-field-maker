...
var Input = exports.default = /*#__PURE__*/function (_Component) {
  ...
  return (0, _createClass2.default)(Input, [{
    ...
    value: function renderRichEditor(item) {
    ...
    key: "renderTable",
    value: function renderTable(item) {
    ...
    value: function renderSelect(item) {
      var _this$props3 = this.props,
        acmscss = _this$props3.acmscss,
        renderValidator = _this$props3.renderValidator,
        renderNoSearch = _this$props3.renderNoSearch;
    ...
    key: "renderRadio",
    value: function renderRadio(item) {
      var _this$props4 = this.props,
        acmscss = _this$props4.acmscss,
        renderValidator = _this$props4.renderValidator,
        renderNoSearch = _this$props4.renderNoSearch;
      return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, item.option.map(function (option) {
        if (!option.label) {
          return null;
        }
    ...
    value: function renderCheckbox(item) {
      var _this$props5 = this.props,
        acmscss = _this$props5.acmscss,
        renderNoSearch = _this$props5.renderNoSearch;
      return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, item.option.map(function (option) {
        if (!option.label) {
          return null;
        }
    ...
    value: function renderImage(item) {
      var _this$props6 = this.props,
        ...
        acmscss = _this$props6.acmscss,
        renderValidator = _this$props6.renderValidator,
        renderNoSearch = _this$props6.renderNoSearch;
      return /*#__PURE__*/_react.default.createElement("span", {
        className: (0, _classnames.default)({
      ...
      }), /*#__PURE__*/_react.default.createElement("br", null), item.alt && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, "\u4EE3\u66FF\u30C6\u30AD\u30B9\u30C8:", /*#__PURE__*/_react.default.createElement("input", {
        type: "text",
    ...
    value: function renderFile(item) {
      var _this$props8 = this.props,
        preview = _this$props8.preview,
        acmscss = _this$props8.acmscss,
        renderValidator = _this$props8.renderValidator,
        renderNoSearch = _this$props8.renderNoSearch;
      ...
      return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, preview ? null : "<!-- BEGIN ".concat(item.name, "@path:veil -->"), /*#__PURE__*/_react.default.createElement("input", {
        type: "hidden",
        name: "".concat(item.name, "@old"),
        value: "{".concat(item.name, "@path}")
      }), /*#__PURE__*/_react.default.createElement("input", {
