...
var Unit = function (_Base) {
  ...
  function Unit(props) {
    ...
    _this.state = (_this$state = {
      ...
      openConverter: false,
      alt: false
    }, (0, _defineProperty3.default)(_this$state, 'resize', true), (0, _defineProperty3.default)(_this$state, 'fileNameMethod', 'random'), (0, _defineProperty3.default)(_this$state, 'useDropArea', true), (0, _defineProperty3.default)(_this$state, 'dropAreaWidth', 200), (0, _defineProperty3.default)(_this$state, 'dropAreaHeight', 200), (0, _defineProperty3.default)(_this$state, 'useFocusImage', false), (0, _defineProperty3.default)(_this$state, 'focusImageWidth', 400), (0, _defineProperty3.default)(_this$state, 'focusImageHeight', 400), (0, _defineProperty3.default)(_this$state, 'mediaType', 'image'), _this$state);
    return _this;
  }
