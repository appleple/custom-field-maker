...
function PreviewNavigator() {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
  ...
  }, editMode !== 'confirm' && /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("select", {
    id: "tag",
    ...
    value: "section"
  }, "\u30E2\u30C0\u30F3"), /*#__PURE__*/_react.default.createElement("option", {
    value: "table"
  }, "\u30C6\u30FC\u30D6\u30EB"))), /*#__PURE__*/_react.default.createElement("div", {
  ...
  }), "acms-admin.css")), (mode === 'customfield' || mode === 'fieldgroup') && /*#__PURE__*/_react.default.createElement("div", {
    className: "acms-admin-form-checkbox",
    style: {
      margin: 0
    }
    ...
    className: "acms-admin-ico-checkbox"
  }), "JavaScript\u306E\u30D0\u30EA\u30C7\u30FC\u30C8"))), tag === 'table' && (mode === 'fieldgroup' || mode === 'unitgroup') && /*#__PURE__*/_react.default.createElement("div", {
    style: {
      marginTop: '5px'
    }
    ...
    effect: "solid",
    className: "acms-admin-tooltip acms-tooltip customFieldTooltip"
  }, /*#__PURE__*/_react.default.createElement("span", null, "\u6A2A\u5411\u304D\u30EC\u30A4\u30A2\u30A6\u30C8\u7528\u306B\u30BD\u30FC\u30B9\u30B3\u30FC\u30C9\u3092\u751F\u6210\u3057\u307E\u3059\u3002")))), /*#__PURE__*/_react.default.createElement("div", {
  ...
  }, editMode !== 'preview' && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_reactCopyToClipboard.default, {
    text: source,
    onCopy: () => setCopied(true)
  }, /*#__PURE__*/_react.default.createElement("button", {
    className: "acms-admin-btn-admin acms-admin-btn-admin-info"
  }, "\u751F\u6210\u30B3\u30FC\u30C9\u3092\u30B3\u30D4\u30FC")), /*#__PURE__*/_react.default.createElement(_Notify.Notify, {
  ...
  }, "\u751F\u6210\u30B3\u30FC\u30C9\u3092\u4E00\u3064\u623B\u3059"), mode === 'customfield' && /*#__PURE__*/_react.default.createElement("button", {
    onClick: () => {
      confirm('生成コードをクリアしますか？');
      clearCustomfield();
    },
    className: "acms-admin-btn-admin acms-admin-btn-admin-danger"
  }, "\u751F\u6210\u30B3\u30FC\u30C9\u3092\u30AF\u30EA\u30A2"), mode === 'fieldgroup' && /*#__PURE__*/_react.default.createElement("button", {
    onClick: () => {
      confirm('生成コードをクリアしますか？');
      clearGroupItem();
    },
    className: "acms-admin-btn-admin acms-admin-btn-admin-danger"
  }, "\u751F\u6210\u30B3\u30FC\u30C9\u3092\u30AF\u30EA\u30A2"), mode === 'customunit' && /*#__PURE__*/_react.default.createElement("button", {
    onClick: () => {
      confirm('生成コードをクリアしますか？');
      clearCustomunit();
    },
    className: "acms-admin-btn-admin acms-admin-btn-admin-danger"
  }, "\u751F\u6210\u30B3\u30FC\u30C9\u3092\u30AF\u30EA\u30A2"), mode === 'unitgroup' && /*#__PURE__*/_react.default.createElement("button", {
    onClick: () => {
      confirm('生成コードをクリアしますか？');
      clearUnitGroupItem();
    },
