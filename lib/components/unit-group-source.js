                  ...
                  if (item.type === 'text') {
                    ...
                    return _this2.wrapTable(_react2.default.createElement(
                      ...
                      _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                          'div',
                          { className: 'js-paper-editor', 'data-heading-start': item.startHeadingLevel, 'data-heading-end': item.endHeadingLevel },
                          _react2.default.createElement('div', { className: 'js-paper-editor-edit' }),
                          _react2.default.createElement('input', { className: 'js-paper-editor-body', type: 'hidden', name: item.name + '[]', value: '{' + item.name + '@html}' })
                        )
                      )
                    ), item.title);
                    ...
                    return _this2.wrapTable(_react2.default.createElement(
                      ...
                      _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                          ...
                          { className: 'js-paper-editor', 'data-heading-start': item.startHeadingLevel, 'data-heading-end': item.endHeadingLevel },
                          _react2.default.createElement('div', { className: 'js-paper-editor-edit' }),
                          _react2.default.createElement('input', { className: 'js-paper-editor-body', type: 'hidden', name: item.name + '{id}[]', value: '' }),
