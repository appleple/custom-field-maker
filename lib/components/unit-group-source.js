                  ...
                  if (item.type === 'text') {
                    ...
                    return _this2.wrapTable(_react2.default.createElement(
                      ...
                      _react2.default.createElement(
                        ...
                        _react2.default.createElement('img', { src: '{' + item.name + '@thumbnail}[resizeImg(400)]', className: (0, _classnames2.default)('js-preview', { 'acms-admin-img-responsive': acmscss }), alt: '{' + item.name + '@alt}' }),
                        '<!-- ELSE -->',
                      ...
                      _react2.default.createElement('input', { type: 'hidden', name: item.name + '{id}[]', value: '{' + item.name + '}', className: 'js-value' })
                    ), item.title);
                  }
                })
              ),
                  ...
                  if (item.type === 'text') {
                    ...
                    return _this2.wrapTable(_react2.default.createElement(
                      ...
                      _react2.default.createElement(
                        'div',
                        null,
                        _react2.default.createElement('img', { src: '', style: { display: "none" }, 'class': 'acms-admin-img-responsive js-preview' })
                      ),
                      _react2.default.createElement(
                        'div',
