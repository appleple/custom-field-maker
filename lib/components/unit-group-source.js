                  ...
                  if (item.type === 'text') {
                    ...
                    return _this2.wrapTable(_react2.default.createElement(
                      ...
                      _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                          'button',
                          { type: 'button', className: (0, _classnames2.default)("js-media-insert", { "acms-admin-btn": acmscss }), 'data-target': '[name="' + item.name + '{id}"]', 'data-preview': '#media-preview{id}-' + item.name },
                          '\u30E1\u30C7\u30A3\u30A2\u9078\u629E'
                        ),
                        _react2.default.createElement(
                          'button',
                  ...
                  if (item.type === 'text') {
                    ...
                    return _this2.wrapTable(_react2.default.createElement(
                      ...
                      _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                          'button',
                          { type: 'button', className: (0, _classnames2.default)("js-media-insert", { "acms-admin-btn": acmscss }), 'data-target': '#media-input{id}-' + item.name, 'data-preview': '#media-preview{id}-' + item.name },
                          '\u30E1\u30C7\u30A3\u30A2\u9078\u629E'
                        ),
                        _react2.default.createElement(
                          'button',
