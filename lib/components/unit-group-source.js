  ...
  (0, _createClass3.default)(UnitGroupSource, [{
    ...
    value: function renderValidator(item, acmscss) {
      ...
      return _react2.default.createElement(
        ...
        item.converter && _react2.default.createElement('input', { type: 'hidden', name: name + '{id}:c', value: item.converter })
      );
    }
  }, {
    key: 'render',
                ...
                unitgroupitems.map(function (item) {
                  if (item.type === 'text') {
                    ...
                    return _this2.wrapTable(_react2.default.createElement(
                      ...
                      _react2.default.createElement('input', { type: 'hidden', name: item.name + '{id}[]', value: preview ? '' : '{' + item.name + '}', className: 'js-value' }),
                      _this2.renderValidator(item, acmscss)
                    ), item.title);
                    ...
                    return _this2.wrapTable(_react2.default.createElement(
                      ...
                      _react2.default.createElement(
                        ...
                        { condition: item.useExpand, wrap: function wrap(children) {
                            return _react2.default.createElement(
                              ...
                              _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                  'button',
                                  { 'class': 'js-expand-btn js-acms-expand-btn', type: 'button' },
                                  _react2.default.createElement('i', { 'class': 'acms-admin-icon acms-admin-icon-expand-arrow js-expand-icon' })
                                ),
                                children
                              )
                            );
                        ...
                        _react2.default.createElement(
                          'div',
                          { 'class': 'js-paper-editor', 'data-heading-start': item.startHeadingLevel, 'data-heading-end': item.endHeadingLevel },
                          _react2.default.createElement('div', { 'class': 'js-paper-editor-edit' }),
                          _react2.default.createElement('input', { 'class': 'js-paper-editor-body', type: 'hidden', name: item.name + '[]', value: '{' + item.name + '@html}' })
                        )
                      )
                    ), item.title);
                    ...
                    return _this2.wrapTable(_react2.default.createElement(
                      ...
                      _react2.default.createElement(
                        'div',
                        { 'class': 'js-editable-table-field' },
                        _react2.default.createElement(
                          'div',
                          { 'class': 'js-editable-table' },
                ...
                unitgroupitems.map(function (item) {
                  if (item.type === 'text') {
                    ...
                    return _this2.wrapTable(_react2.default.createElement(
                      ...
                      _react2.default.createElement('input', { type: 'hidden', name: item.name + '{id}[]', value: '', className: 'js-value' })
                    ), item.title);
                  } else if (item.type === 'lite-editor') {
                    return _this2.wrapTable(_react2.default.createElement(
                      'td',
                      null,
                      _react2.default.createElement('textarea', { name: item.name + '{id}[]', className: (0, _classnames2.default)('js-lite-editor-field', { 'acms-admin-form-width-full': acmscss }) }),
                      _this2.renderValidator(item, acmscss, false)
                    ), item.title);
                  } else if (item.type === 'paper-editor') {
                    return _this2.wrapTable(_react2.default.createElement(
                      ...
                      _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                          ...
                          { 'class': 'js-paper-editor', 'data-heading-start': item.startHeadingLevel, 'data-heading-end': item.endHeadingLevel },
                          _react2.default.createElement('div', { 'class': 'js-paper-editor-edit' }),
                          _react2.default.createElement('input', { 'class': 'js-paper-editor-body', type: 'hidden', name: item.name + '{id}[]', value: '' }),
                          _react2.default.createElement('input', { type: 'hidden', name: item.name + '{id}:extension', value: 'paper-editor' })
                        )
                      )
                    ), item.title);
                  } else if (item.type === 'table') {
                    return _this2.wrapTable(_react2.default.createElement(
                      ...
                      _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                          ...
                          '<!-- END_IF -->',
                          _react2.default.createElement('input', { type: 'hidden', className: 'js-editable-table-dest', value: '', name: item.name + '{id}[]' })
                        )
                      )
                    ), item.title);
                  }
