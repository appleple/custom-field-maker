                    ...
                    return _this2.wrapTable(_react2.default.createElement(
                      ...
                      _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                          ...
                          { className: 'js-smartblock', 'data-heading-start': item.startHeadingLevel, 'data-heading-end': item.endHeadingLevel },
                          _react2.default.createElement('div', { className: 'js-smartblock-edit' }),
                          _react2.default.createElement('input', { className: 'js-smartblock-body', type: 'hidden', name: item.name + '{id}[]', value: '' }),
                          _react2.default.createElement('input', { type: 'hidden', name: item.name + '{id}:extension', value: 'rich-editor' })
                        )
                      )
                    ), item.title);
                  } else if (item.type === 'table') {
        ...
        unitGroupName && _react2.default.createElement(
          ...
          unitgroupitems.map(function (item) {
            return _react2.default.createElement(
              ...
              item.type === 'rich-editor' && _react2.default.createElement(
                _react.Fragment,
                null,
                _react2.default.createElement('input', { type: 'hidden', name: item.name + '{id}:extension', value: 'rich-editor' })
              ),
