                  ...
                  if (item.type === 'text') {
                    ...
                    return _this2.wrapTable(_react2.default.createElement(
                      ...
                      _react2.default.createElement(
                        ...
                        _react2.default.createElement('img', { src: '{' + item.name + '@thumbnail}', className: (0, _classnames2.default)({ "acms-admin-img-responsive": acmscss }), alt: '{' + item.name + '@alt}', id: 'media-preview{id}-' + item.name }),
                        '<!-- ELSE -->',
                      ...
                      _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                          'button',
                          { type: 'button', className: (0, _classnames2.default)("js-media-edit", { "acms-admin-btn": acmscss }), 'data-mid': '{' + item.name + '}', 'data-target': '[name="' + item.name + '{id}"]', 'data-preview': '#media-preview{id}-' + item.name },
                          '\u30E1\u30C7\u30A3\u30A2\u7DE8\u96C6'
                        ),
                        _react2.default.createElement(
                          'button',
                          { type: 'button', className: (0, _classnames2.default)("js-media-insert", { "acms-admin-btn": acmscss }), 'data-target': '[name="' + item.name + '{id}"]', 'data-preview': '#media-preview{id}-' + item.name, 'data-type': item.mediaType ? item.mediaType : 'all' },
                          '\u30E1\u30C7\u30A3\u30A2\u9078\u629E'
                        ),
                        _react2.default.createElement(
                          'button',
                          { type: 'button', className: (0, _classnames2.default)("js-media-remove", { "acms-admin-btn acms-admin-btn-danger": acmscss }), 'data-target': '[name="' + item.name + '{id}"]', 'data-preview': '#media-preview{id}-' + item.name },
                          '\u30E1\u30C7\u30A3\u30A2\u524A\u9664'
                        )
                      ),
                  ...
                  if (item.type === 'text') {
                    ...
                    return _this2.wrapTable(_react2.default.createElement(
                      ...
                      _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                          'button',
                          { type: 'button', className: (0, _classnames2.default)("js-media-insert", { "acms-admin-btn": acmscss }), 'data-target': '#media-input{id}-' + item.name, 'data-preview': '#media-preview{id}-' + item.name, 'data-type': item.mediaType ? item.mediaType : 'all' },
                          '\u30E1\u30C7\u30A3\u30A2\u9078\u629E'
                        ),
                        _react2.default.createElement(
                          'button',
                          { type: 'button', className: (0, _classnames2.default)("js-media-edit", { "acms-admin-btn": acmscss }), 'data-target': '#media-input{id}-' + item.name, 'data-preview': '#media-preview{id}-' + item.name },
                          '\u30E1\u30C7\u30A3\u30A2\u7DE8\u96C6'
                        ),
                        _react2.default.createElement(
                          'button',
                          { type: 'button', className: (0, _classnames2.default)("js-media-remove", { "acms-admin-btn acms-admin-btn-danger": acmscss }), 'data-target': '#media-input{id}-' + item.name, 'data-preview': '#media-preview{id}-' + item.name },
                          '\u30E1\u30C7\u30A3\u30A2\u524A\u9664'
                        )
                      ),
