...
exports.GroupTableLayoutConfirm = GroupTableLayoutConfirm;
var _react = _interopRequireDefault(require("react"));
var _classnames = _interopRequireDefault(require("classnames"));
var _MakerContext = require("../../store/MakerContext");
var _WrapTable = require("../html/WrapTable");
function GroupTableLayoutConfirm() {
  const {
    state: {
      fieldgroup
    },
  ...
  }, fieldgroup.title), /*#__PURE__*/_react.default.createElement("table", {
    className: (0, _classnames.default)({
      'adminTable acms-admin-table-admin-edit': acmscss
    })
  }, direction === 'horizontal' && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, fieldgroup && /*#__PURE__*/_react.default.createElement("thead", {
    className: (0, _classnames.default)({
      'acms-admin-hide-sp': acmscss
    })
  }, /*#__PURE__*/_react.default.createElement("tr", null, fieldgroup.items.map((item, index) => /*#__PURE__*/_react.default.createElement("th", {
    key: index,
    className: (0, _classnames.default)({
      'acms-admin-table-left': acmscss
    })
  }, item.title))))), /*#__PURE__*/_react.default.createElement("tbody", null, "<!-- BEGIN ".concat(fieldgroup.name, ":loop -->"), /*#__PURE__*/_react.default.createElement("tr", null, /*#__PURE__*/_react.default.createElement(ConditionalWrap, {
