...
function ImageInput(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, mode === 'customfield' && /*#__PURE__*/_react.default.createElement("div", {
  ...
  }, editMode === 'preview' ? null : "<!-- BEGIN_IF [{".concat(item.name, "@path}/nem] -->"), /*#__PURE__*/_react.default.createElement("img", {
  ...
  }), "\u524A\u9664")), editMode === 'preview' ? null : '<!-- ELSE -->', /*#__PURE__*/_react.default.createElement("img", {
    alt: "",
    src: "%{ARCHIVES_DIR}{".concat(item.name, "@path}"),
    className: (0, _classnames.default)({
      'acms-admin-img-responsive': acmscss,
  ...
  }, isAttribute && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, editMode === 'preview' ? null : "<!-- BEGIN_IF [{".concat(item.name, "@path}/nem] -->"), /*#__PURE__*/_react.default.createElement("img", {
    src: "%{ARCHIVES_DIR}{".concat(item.name, "@path}"),
    className: (0, _classnames.default)({
      'js-img_resize_preview': item.resize
    }),
    ...
    style: hiddenStyle
  }), editMode === 'preview' ? null : '<!-- END_IF -->'), !isAttribute && /*#__PURE__*/_react.default.createElement("img", {
    src: "",
    alt: "",
    style: hiddenStyle,
    ...
    name: "".concat(item.name, "@").concat(item.square, "[]"),
    value: item.squareSize
  }))), mode === 'customunit' && /*#__PURE__*/_react.default.createElement("span", {
    className: (0, _classnames.default)({
      'js-img_resize_cf': item.resize
    })
  }, editMode === 'preview' ? null : "<!-- BEGIN_IF [{".concat(item.name, "@path}/nem] -->"), /*#__PURE__*/_react.default.createElement("img", {
  ...
  }, isAttribute && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, editMode === 'preview' ? null : "<!-- BEGIN_IF [{".concat(item.name, "@path}/nem] -->"), /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("img", {
    src: "%{ARCHIVES_DIR}{".concat(item.name, "@path}"),
    className: (0, _classnames.default)({
      'js-img_resize_preview': item.resize
    }),
    ...
    style: hiddenStyle
  }), isAttribute && editMode === 'preview' ? null : '<!-- END_IF -->', /*#__PURE__*/_react.default.createElement("input", {
    type: "file",
    name: "".concat(item.name, "{id}[]"),
    className: (0, _classnames.default)({
      'js-img_resize_input': item.resize
