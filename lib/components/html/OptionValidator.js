...
function OptionValidator(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.Fragment, {
    ...
    }), jsValidator ? /*#__PURE__*/_react.default.createElement("div", {
    ...
    }), validator.message)) : /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, validator.message && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, editMode === 'preview' ? null : "<!-- BEGIN ".concat(name, ":validator#").concat(validator.option, " -->"), /*#__PURE__*/_react.default.createElement("p", {
      className: (0, _classnames.default)({
        'acms-admin-text-error': acmscss
      })
    }, validator.message), editMode === 'preview' ? null : "<!-- END ".concat(name, ":validator#").concat(validator.option, " -->"))));
  }), item.converter && (() => {
    switch (mode) {
      case 'customfield':
      case 'fieldgroup':
