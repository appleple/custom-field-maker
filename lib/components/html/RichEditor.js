...
function RichEditor(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, mode === 'customfield' && /*#__PURE__*/_react.default.createElement(ConditionalWrap, {
    ...
    value: "rich-editor"
  }))), mode === 'fieldgroup' && /*#__PURE__*/_react.default.createElement(ConditionalWrap, {
    condition: item.useExpand,
    wrap: children => /*#__PURE__*/_react.default.createElement("div", {
      className: "js-expand js-acms-expand"
    }, /*#__PURE__*/_react.default.createElement("div", {
    ...
    className: "js-smartblock-edit"
  }), isValue ? /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("input", {
    id: id,
    className: "js-smartblock-body",
    type: "hidden",
    ...
    name: "".concat(item.name, "[]"),
    value: ""
  }))), mode === 'customunit' && /*#__PURE__*/_react.default.createElement(ConditionalWrap, {
    condition: item.useExpand,
    wrap: children => /*#__PURE__*/_react.default.createElement("div", {
      className: "js-expand js-acms-expand"
    }, /*#__PURE__*/_react.default.createElement("div", {
    ...
    value: "rich-editor"
  }))), mode === 'unitgroup' && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(ConditionalWrap, {
    condition: item.useExpand,
    wrap: children => /*#__PURE__*/_react.default.createElement("div", {
      className: "js-expand js-acms-expand"
    }, /*#__PURE__*/_react.default.createElement("div", {
    ...
    className: "js-smartblock-edit"
  }), isValue ? /*#__PURE__*/_react.default.createElement("input", {
    className: "js-smartblock-body",
    type: "hidden",
    name: "".concat(item.name, "{id}[]"),
    value: "{".concat(item.name, "@html}")
