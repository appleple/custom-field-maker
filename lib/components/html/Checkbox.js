...
function Checkbox(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, mode === 'customfield' && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, item.option.map((option, index) => {
    if (!option.label) {
      return null;
    }
  ...
  })), mode === 'fieldgroup' && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, item.option.map((option, index) => {
    if (!option.label) {
      return null;
    }
    return /*#__PURE__*/_react.default.createElement("div", {
  ...
  })), mode === 'customunit' && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, item.option.map((option, index) => {
    if (!option.label) {
      return null;
    }
    return /*#__PURE__*/_react.default.createElement("div", {
    ...
    name: item.name,
    noSearch: item.noSearch
  })), mode === 'unitgroup' && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, item.option.map((option, index) => {
    if (!option.label) {
      return null;
    }
    return /*#__PURE__*/_react.default.createElement("div", {
      ...
      id: "input-checkbox-".concat(item.name, "-{id}-").concat(option.value)
    })), /*#__PURE__*/_react.default.createElement("label", {
      htmlFor: "input-checkbox-".concat(item.name, "-{id}-").concat(option.value)
