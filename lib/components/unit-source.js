      ...
      return _react2.default.createElement(
        ...
        item.validator.map(function (validator) {
          ...
          return _react2.default.createElement(
            _react.Fragment,
            null,
            _react2.default.createElement('input', { type: 'hidden', name: item.name + ':v#' + validator.option, value: validator.value }),
            ...
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement('img', { src: '{' + item.name + '@thumbnail}',
                    className: (0, _classnames2.default)({ 'acms-admin-img-responsive': acmscss }),
                ...
                _react2.default.createElement(
                  'div',
                  { 'class': 'acms-admin-margin-top-mini' },
                  '<!-- BEGIN_IF [{' + item.name + '@thumbnail}/nem] -->',
                  _react2.default.createElement(
                    'button',
                    { 'class': 'js-media-edit acms-admin-btn', 'data-mid': '{' + item.name + '}', 'data-preview': '#' + item.name + '{id}-preview', 'data-target': '#' + item.name + '-input' },
                    '\u30E1\u30C7\u30A3\u30A2\u7DE8\u96C6'
                  ),
                  '<!-- END_IF -->',
                  _react2.default.createElement(
                    'button',
                    { className: (0, _classnames2.default)("js-media-insert", { "acms-admin-btn": acmscss }), 'data-target': '#' + item.name + '{id}-input', 'data-preview': '#' + item.name + '{id}-preview', 'data-type': item.mediaType ? item.mediaType : 'all' },
                    '\u30E1\u30C7\u30A3\u30A2\u9078\u629E'
                  ),
                  _react2.default.createElement(
                    'button',
                    { className: (0, _classnames2.default)("js-media-remove", { "acms-admin-btn acms-admin-btn-danger": acmscss }), 'data-target': '#' + item.name + '{id}-input', 'data-preview': '#' + item.name + '{id}-preview' },
                    '\u30E1\u30C7\u30A3\u30A2\u524A\u9664'
                  )
                ),
                _react2.default.createElement('input', { type: 'hidden', name: item.name + '{id}', value: '{' + item.name + '}', className: (0, _classnames2.default)({ 'acms-admin-form-width-full': acmscss }), id: item.name + '{id}-input' }),
                _react2.default.createElement('input', { type: 'hidden', name: 'unit{id}[]', value: item.name + '{id}' }),
