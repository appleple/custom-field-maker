          ...
          if (item.type === 'text') {
            ...
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  'textarea',
                  (0, _extends3.default)({ name: item.name + '{id}', className: (0, _classnames2.default)('js-lite-editor-field', { 'acms-admin-form-width-full': acmscss }) }, jsValidator ? { 'data-validator': item.name } : {}),
                  '{' + item.name + '}'
                ),
                _react2.default.createElement('input', { type: 'hidden', name: 'unit{id}[]', value: item.name + '{id}' }),
                _this2.renderValidator(item, acmscss),
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    ...
                    _react2.default.createElement('input', { 'class': 'js-paper-editor-body', type: 'hidden', name: item.name + '{id}', value: '{' + item.name + '@html}' }),
                    _react2.default.createElement('input', { type: 'hidden', name: 'unit{id}[]', value: item.name + '{id}' }),
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    ...
                    '<!-- END_IF -->',
                    _react2.default.createElement('input', { type: 'hidden', className: 'js-editable-table-dest', value: '{' + item.name + '}', name: item.name + '{id}' }),
                    _react2.default.createElement('input', { type: 'hidden', name: 'unit{id}[]', value: item.name + '{id}' })
                  )
                )
              )
