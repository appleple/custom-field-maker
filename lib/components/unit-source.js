          ...
          if (item.type === 'text') {
            ...
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement('img', { src: '%{ARCHIVES_DIR}{' + item.name + '@' + item.path + '}', className: (0, _classnames2.default)({ 'acms-admin-img-responsive': acmscss, 'js-img_resize_preview': item.resize }), style: item.normalSize ? { width: item.normalSize + 'px' } : null }),
                _react2.default.createElement('input', { type: 'hidden', name: item.name + '{id}@old', value: '{' + item.name + '@path}' }),
                _react2.default.createElement(
                  'div',
                  { className: (0, _classnames2.default)({ 'acms-admin-form-checkbox': acmscss }) },
                  _react2.default.createElement('input', { type: 'checkbox', name: item.name + '{id}@edit', value: 'delete', id: 'input-checkbox-' + item.name + '@edit' }),
                  _react2.default.createElement(
                    'label',
                ...
                preview ? null : '<!-- ELSE -->',
                _react2.default.createElement('img', { src: '%{ARCHIVES_DIR}{' + item.name + '@' + item.path + '}', className: (0, _classnames2.default)({ 'acms-admin-img-responsive': acmscss, 'js-img_resize_preview': item.resize }), style: item.normalSize ? { width: item.normalSize + 'px', display: 'none' } : { display: 'none' } }),
                preview ? null : '<!-- END_IF -->',
            ...
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement('input', { type: 'hidden', name: 'field[]', value: item.name + '{id}' }),
                ...
                item.fileName && _react2.default.createElement('input', { type: 'hidden', name: item.name + '{id}@filename', value: item.fileName }),
                _this2.renderValidator(item, acmscss)
              )
            );
          }
