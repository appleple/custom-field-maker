            ...
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    'button',
                    { 'class': 'js-media-edit acms-admin-btn', 'data-mid': '{' + item.name + '}', 'data-preview': '#' + item.name + '{id}-preview', id: item.name + '{id}-edit' },
                    '\u30E1\u30C7\u30A3\u30A2\u7DE8\u96C6'
                  ),
                  '<!-- END_IF -->',
                  _react2.default.createElement(
                    'button',
                    { className: (0, _classnames2.default)("js-media-insert", { "acms-admin-btn": acmscss }), 'data-target': '#' + item.name + '{id}-input', 'data-preview': '#' + item.name + '{id}-preview', 'data-edit': '#' + item.name + '{id}-edit' },
                    '\u30E1\u30C7\u30A3\u30A2\u9078\u629E'
                  )
                ),
