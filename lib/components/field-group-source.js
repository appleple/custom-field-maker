                  ...
                  if (item.type === 'text') {
                    ...
                    return _this2.wrapTable(_react2.default.createElement(
                      ...
                      _react2.default.createElement(
                        ...
                        _react2.default.createElement('img', { src: '%{MEDIA_ARCHIVES_DIR}{test@thumbnail}', className: (0, _classnames2.default)({ "acms-admin-img-responsive": acmscss }), alt: '{test@alt}', id: 'media-preview-' + item.name }),
                        '<!-- ELSE -->',
                      ...
                      _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                          'button',
                          { type: 'button', className: (0, _classnames2.default)("js-media-edit", { "acms-admin-btn": acmscss }), 'data-mid': '{' + item.name + '}', 'data-preview': '#media-preview-' + item.name, id: 'media-edit-' + item.name },
                          '\u30E1\u30C7\u30A3\u30A2\u7DE8\u96C6'
                        ),
                        '<!-- END_IF -->',
                        _react2.default.createElement(
                          'button',
                          { type: 'button', className: (0, _classnames2.default)("js-media-insert", { "acms-admin-btn": acmscss }), 'data-target': '#media-input-' + item.name, 'data-preview': '#media-preview-' + item.name, 'data-edit': '#media-edit-' + item.name },
                          '\u30E1\u30C7\u30A3\u30A2\u9078\u629E'
                        )
                      ),
