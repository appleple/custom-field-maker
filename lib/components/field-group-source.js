                  ...
                  if (item.type === 'text') {
                    ...
                    return _this2.wrapTable(_react2.default.createElement(
                      ...
                      _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                          'button',
                          { type: 'button', className: (0, _classnames2.default)("js-media-insert", { "acms-admin-btn": acmscss }), 'data-target': '#media-input-' + item.name, 'data-preview': '#media-preview-' + item.name },
                          '\u30E1\u30C7\u30A3\u30A2\u9078\u629E'
                        ),
                        _react2.default.createElement(
                          'button',
                  ...
                  if (item.type === 'text') {
                    ...
                    return _this2.wrapTable(_react2.default.createElement(
                      ...
                      _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                          'button',
                          { type: 'button', 'class': 'js-media-edit acms-admin-btn', 'data-target': '#media-input-' + item.name, 'data-preview': '#media-preview-' + item.name },
                          '\u30E1\u30C7\u30A3\u30A2\u9078\u629E'
                        ),
                        _react2.default.createElement(
                          'button',
