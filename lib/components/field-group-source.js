...
function (_Component) {
  ...
  function FieldGroupSource(props) {
    ...
    return (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(FieldGroupSource).call(this, props));
  }
  ...
  (0, _createClass2.default)(FieldGroupSource, [{
    ...
    value: function renderValidator(item, acmscss) {
      ...
      return _react.default.createElement(_react.Fragment, null, item.validator.map(function (validator) {
        ...
        return _react.default.createElement(_react.Fragment, null, !jsValidator && !bottom && _react.default.createElement(_react.Fragment, null, validator.message && _react.default.createElement(_react.Fragment, null, preview ? null : "<!-- BEGIN ".concat(name, ":validator#").concat(validator.option, " -->"), _react.default.createElement("p", {
    ...
    value: function render() {
      ...
      return _react.default.createElement(_react.Fragment, null, groupTitle && _react.default.createElement("h2", {
      ...
      }, groupTitle), groupName && _react.default.createElement("table", {
      ...
      }, "\xA0"), direction === 'horizontal' && _react.default.createElement(_react.Fragment, null, groupitems.map(function (item) {
      ...
      }, "\u524A\u9664"))), _react.default.createElement("tbody", null, preview ? null : "<!-- BEGIN ".concat(groupName, ":loop -->"), _react.default.createElement("tr", {
        ...
        if (item.type === 'text') {
          ...
          }), item.tinySize && _react.default.createElement("input", {
            type: "hidden",
            name: "".concat(item.name, "@").concat(item.tiny, "[]"),
            value: item.tinySize
          }), item.largeSize && _react.default.createElement("input", {
            type: "hidden",
        ...
        value: "\u524A\u9664"
      }))), preview ? null : "<!-- END ".concat(groupName, ":loop -->"), preview ? null : _react.default.createElement("tr", {
        ...
        if (item.type === 'text') {
          ...
          return _this.wrapTable(_react.default.createElement("td", null, _react.default.createElement(ConditionalWrap, {
            ...
            className: "js-smart-block",
            "data-heading-start": item.startHeadingLevel,
            "data-heading-end": item.endHeadingLevel
          }, _react.default.createElement("div", {
            className: "js-smart-block-edit"
          }), _react.default.createElement("input", {
            className: "js-smart-block-body",
            type: "hidden",
            name: "".concat(item.name, "[]"),
            value: ""
          })))), item.title);
        ...
        value: "\u8FFD\u52A0"
      }))))), groupName && _react.default.createElement(_react.Fragment, null, groupitems.map(function (item) {
        return _react.default.createElement(_react.Fragment, null, item.type === 'image' && _react.default.createElement(_react.Fragment, null, item.square && _react.default.createElement(_react.Fragment, null, _react.default.createElement("input", {
          type: "hidden",
        ...
        })), item.large && _react.default.createElement(_react.Fragment, null, _react.default.createElement("input", {
          type: "hidden",
          name: "@".concat(groupName, "[]"),
        ...
        })), item.tiny && _react.default.createElement(_react.Fragment, null, _react.default.createElement("input", {
          type: "hidden",
          name: "@".concat(groupName, "[]"),
          ...
          var name = item.type === 'file' || item.type === 'image' ? "".concat(item.name, "@path") : item.name;
          return item.converter && _react.default.createElement("input", {
            type: "hidden",
            name: "".concat(name, ":c"),
