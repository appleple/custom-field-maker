    ...
    value: function renderValidator(item, acmscss) {
      ...
      return _react2.default.createElement(
        ...
        item.validator.map(function (validator) {
          var classSuffix = bottom ? '1' : '{' + item.name + ':v#' + validator.option + '}';
          return _react2.default.createElement(
            _react.Fragment,
            null,
            ...
            jsValidator && _react2.default.createElement(
              'div',
              { 'data-validator-label': item.name + '-v-' + validator.option, className: 'validator-result-' + classSuffix },
              _react2.default.createElement(
                'p',
                  ...
                  if (item.type === 'text') {
                    ...
                    return _this2.wrapTable(_react2.default.createElement(
                      ...
                      _react2.default.createElement(
                        ...
                        _react2.default.createElement('img', { src: '{' + item.name + '@thumbnail}', className: (0, _classnames2.default)({ "acms-admin-img-responsive": acmscss }), alt: '{' + item.name + '@alt}', id: 'media-preview-' + item.name }),
                        '<!-- ELSE -->',
                        _react2.default.createElement('img', { src: '', style: { display: "none" }, className: (0, _classnames2.default)({ "acms-admin-img-responsive": acmscss }), id: 'media-preview-' + item.name }),
                        '<!-- END_IF -->'
                      ),
                      _react2.default.createElement(
                        'div',
                        ...
                        _react2.default.createElement(
                          'button',
                          { type: 'button', className: (0, _classnames2.default)("js-media-edit", { "acms-admin-btn": acmscss }), 'data-mid': '{' + item.name + '}', 'data-target': '#media-input-' + item.name, 'data-preview': '#media-preview-' + item.name },
                          '\u30E1\u30C7\u30A3\u30A2\u7DE8\u96C6'
                        ),
                        _react2.default.createElement(
                          'button',
                          { type: 'button', className: (0, _classnames2.default)("js-media-insert", { "acms-admin-btn": acmscss }), 'data-target': '#media-input-' + item.name, 'data-preview': '#media-preview-' + item.name, 'data-type': item.mediaType ? item.mediaType : 'all' },
                          '\u30E1\u30C7\u30A3\u30A2\u9078\u629E'
                        ),
                        _react2.default.createElement(
                          'button',
                          { type: 'button', className: (0, _classnames2.default)("js-media-remove", { "acms-admin-btn acms-admin-btn-danger": acmscss }), 'data-target': '#media-input-' + item.name, 'data-preview': '#media-preview-' + item.name },
                          '\u30E1\u30C7\u30A3\u30A2\u524A\u9664'
                        )
                      ),
                      _react2.default.createElement('input', { type: 'hidden', name: item.name + '[]', value: '{' + item.name + '}', className: 'acms-admin-form-width-full', id: 'media-input-' + item.name })
                    ), item.title);
                  }
                })
              ),
                  ...
                  if (item.type === 'text') {
                    ...
                    return _this2.wrapTable(_react2.default.createElement(
                      ...
                      _react2.default.createElement(
                        'div',
                        null,
                        _react2.default.createElement('img', { src: '', style: { display: "none" }, 'class': 'acms-admin-img-responsive', id: 'media-preview-' + item.name })
                      ),
                      _react2.default.createElement(
                        'div',
                        ...
                        _react2.default.createElement(
                          'button',
                          { type: 'button', 'class': 'js-media-insert acms-admin-btn', 'data-target': '#media-input-' + item.name, 'data-preview': '#media-preview-' + item.name },
                          '\u30E1\u30C7\u30A3\u30A2\u9078\u629E'
                        ),
                        _react2.default.createElement(
                          'button',
                          { type: 'button', 'class': 'js-media-edit acms-admin-btn', 'data-target': '#media-input-' + item.name, 'data-preview': '#media-preview-' + item.name, 'data-type': item.mediaType ? item.mediaType : 'all' },
                          '\u30E1\u30C7\u30A3\u30A2\u9078\u629E'
                        ),
                        _react2.default.createElement(
                          'button',
                          { type: 'button', className: (0, _classnames2.default)("js-media-remove", { "acms-admin-btn acms-admin-btn-danger": acmscss }), 'data-target': '#media-input-' + item.name, 'data-preview': '#media-preview{id}-' + item.name },
                          '\u30E1\u30C7\u30A3\u30A2\u524A\u9664'
                        )
                      ),
                      _react2.default.createElement('input', { type: 'hidden', name: item.name + '[]', value: '{' + item.name + '}', 'class': 'acms-admin-form-width-full', id: 'media-input-' + item.name })
                    ), item.title);
                  }
                })
              ),
