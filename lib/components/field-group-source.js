                  ...
                  if (item.type === 'text') {
                    ...
                    return _this2.wrapTable(_react2.default.createElement(
                      ...
                      _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                          'button',
                          { type: 'button', className: (0, _classnames2.default)("js-media-edit", { "acms-admin-btn": acmscss }), 'data-mid': '{' + item.name + '}', 'data-preview': '#media-preview-' + item.name, 'data-target': '#' + item.name + '-input' },
                          '\u30E1\u30C7\u30A3\u30A2\u7DE8\u96C6'
                        ),
                        '<!-- END_IF -->',
                        _react2.default.createElement(
