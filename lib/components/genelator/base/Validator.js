...
function Validator(props) {
  ...
  const isConverter = (0, _react.useMemo)(() => {
    const possibleConverter = ['text', 'tel', 'number', 'email', 'password', 'textarea', 'checkbox', 'selectbox', 'radioButton'];
  ...
  const updateValidatorOption = (idx, option) => {
    ...
    setField(prevState => ({
      ...prevState,
      validator: [...validator.slice(0, idx), {
        ...item,
        option
  ...
  return /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("button", {
    ...
    type: "button",
    value: openValidator,
    onClick: () => setField(prevState => ({
      ...prevState,
      openValidator: !openValidator
    }))
  }, /*#__PURE__*/_react.default.createElement("span", {
    className: "customFieldValidatorToggle"
  }), "\u30D5\u30A9\u30FC\u30E0\u30AA\u30D7\u30B7\u30E7\u30F3\u3092\u8A2D\u5B9A")), /*#__PURE__*/_react.default.createElement("div", {
  ...
  }, isConverter && /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("div", {
    className: "customFieldBold"
  }, "\u30B3\u30F3\u30D0\u30FC\u30BF\u30FC", /*#__PURE__*/_react.default.createElement("i", {
  ...
  }, /*#__PURE__*/_react.default.createElement("span", null, "\u30C6\u30AD\u30B9\u30C8\u30D5\u30A3\u30FC\u30EB\u30C9\u306B\u5165\u529B\u3055\u308C\u305F\u5024\u3092\u5225\u306E\u5024\u306B\u5909\u63DB\u3057\u307E\u3059\u3002\u8A73\u3057\u304F\u306F\u53C2\u7167\u30DC\u30BF\u30F3\u3092\u62BC\u3059\u3068\u8868\u793A\u3055\u308C\u308B\u30E2\u30FC\u30C0\u30EB\u30A6\u30A3\u30F3\u30C9\u30A6\u306B\u60C5\u5831\u304C\u8A18\u8F09\u3055\u308C\u3066\u3044\u307E\u3059\u3002"))), /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("input", {
    type: "text",
    value: converter,
    onChange: e => {
  ...
  }, "\u53C2\u7167"))), (mode === 'customfield' || mode === 'fieldgroup') && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("table", {
    className: "acms-admin-table customFieldOptionTable",
    style: {
      borderTop: 0
    }
  }, /*#__PURE__*/_react.default.createElement("tbody", null, /*#__PURE__*/_react.default.createElement("tr", null, /*#__PURE__*/_react.default.createElement("th", null, "\u30D0\u30EA\u30C7\u30FC\u30BF\u30FC", /*#__PURE__*/_react.default.createElement("i", {
    className: "acms-admin-icon-tooltip",
    "data-tip": true,
    ...
    effect: "solid",
    className: "acms-admin-tooltip acms-tooltip customFieldTooltip"
  }, /*#__PURE__*/_react.default.createElement("span", null, "\u30D5\u30A3\u30FC\u30EB\u30C9\u306B\u5165\u529B\u3055\u308C\u3066\u3044\u308B\u5024\u304C\u6761\u4EF6\u306B\u5408\u308F\u306A\u304B\u3063\u305F\u5834\u5408\u306B\u8868\u793A\u3055\u308C\u308B\u30E1\u30C3\u30BB\u30FC\u30B8\u306B\u306A\u308A\u307E\u3059\u3002"))), /*#__PURE__*/_react.default.createElement("th", null)), validator && validator.map((item, idx) => /*#__PURE__*/_react.default.createElement("tr", {
    ...
    value: ""
  }, "\u25BC \u9078\u629E"), /*#__PURE__*/_react.default.createElement("optgroup", {
    label: "\u5165\u529B\u5024\u306E\u5236\u9650"
  }, /*#__PURE__*/_react.default.createElement("option", {
    value: "required"
  ...
  }, "\u524A\u9664")))))), /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("button", {
    onClick: addValidator,
    className: "acms-admin-btn"
  }, "\u8FFD\u52A0"))), /text|number|tel|email|password|textarea|radioButton|selectbox/.exec(type) && /*#__PURE__*/_react.default.createElement(_NoSearchBox.NoSearchBox, {
    noSearch: noSearch,
    setField: setField
  }))));
}