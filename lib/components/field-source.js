              ...
              return _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                      'button',
                      { type: 'button', 'class': 'js-media-edit acms-admin-btn', 'data-mid': '{' + item.name + '}', 'data-target': '#' + item.name + '-input', 'data-preview': '#' + item.name + '-preview' },
                      '\u30E1\u30C7\u30A3\u30A2\u7DE8\u96C6'
                    ),
                    '<!-- END_IF -->',
                    _react2.default.createElement(
                      'button',
                      { type: 'button', className: (0, _classnames2.default)("js-media-insert", { "acms-admin-btn": acmscss }), 'data-target': '#' + item.name + '-input', 'data-preview': '#' + item.name + '-preview', 'data-type': item.mediaType ? item.mediaType : 'all' },
                      '\u30E1\u30C7\u30A3\u30A2\u9078\u629E'
                    ),
                    _react2.default.createElement(
                      'button',
                      { type: 'button', className: (0, _classnames2.default)("js-media-remove", { "acms-admin-btn acms-admin-btn-danger": acmscss }), 'data-target': '#' + item.name + '-input', 'data-preview': '#' + item.name + '-preview' },
                      '\u30E1\u30C7\u30A3\u30A2\u524A\u9664'
                    )
                  ),
                  _react2.default.createElement('input', { type: 'hidden', name: item.name, value: '{' + item.name + '}', className: (0, _classnames2.default)({ 'acms-admin-form-width-full': acmscss }), id: item.name + '-input' }),
                  _react2.default.createElement('input', { type: 'hidden', name: 'field[]', value: item.name }),
