            ...
            if (item.type === 'text') {
              ...
              return _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    'textarea',
                    (0, _extends3.default)({ name: item.name, className: (0, _classnames2.default)('js-lite-editor-field', { 'acms-admin-form-width-full': acmscss }) }, jsValidator ? { 'data-validator': item.name } : {}),
                    '{' + item.name + '}'
                  ),
                  _react2.default.createElement('input', { type: 'hidden', name: 'field[]', value: item.name }),
                  _this2.renderValidator(item, acmscss),
