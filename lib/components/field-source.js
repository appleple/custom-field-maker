...
var FieldSource = /*#__PURE__*/function (_Component) {
  (0, _inherits2.default)(FieldSource, _Component);
  var _super = _createSuper(FieldSource);
  ...
  (0, _createClass2.default)(FieldSource, [{
    ...
    value: function renderValidator(item, acmscss) {
      ...
      return /*#__PURE__*/_react.default.createElement(_react.Fragment, null, item.validator.map(function (validator) {
        ...
        }), !jsValidator && /*#__PURE__*/_react.default.createElement(_react.Fragment, null, validator.message && /*#__PURE__*/_react.default.createElement(_react.Fragment, null, preview ? null : "<!-- BEGIN ".concat(name, ":validator#").concat(validator.option, " -->"), /*#__PURE__*/_react.default.createElement("p", {
    ...
    value: function renderTh(item) {
      ...
      return /*#__PURE__*/_react.default.createElement("th", null, item.title, item.tooltip && /*#__PURE__*/_react.default.createElement("i", {
      ...
      return /*#__PURE__*/_react.default.createElement(_react.Fragment, null, jsValidator && '<!-- <form action="" method="post" class="js-validator" enctype="multipart/form-data"> -->', /*#__PURE__*/_react.default.createElement("table", {
        ...
        if (item.type === 'text') {
          return /*#__PURE__*/_react.default.createElement("tr", {
            key: index
          }, _this.renderTh(item, acmscss, jsValidator), /*#__PURE__*/_react.default.createElement("td", null, /*#__PURE__*/_react.default.createElement("input", (0, _extends2.default)({
            type: "text",
            name: item.name,
          ...
          return /*#__PURE__*/_react.default.createElement("tr", {
            key: index
          }, _this.renderTh(item, acmscss), /*#__PURE__*/_react.default.createElement("td", null, /*#__PURE__*/_react.default.createElement("textarea", (0, _extends2.default)({
            name: item.name,
            className: (0, _classnames.default)({
              'acms-admin-form-width-full': acmscss
            })
          ...
          return /*#__PURE__*/_react.default.createElement("tr", {
            key: index
          }, _this.renderTh(item, acmscss), /*#__PURE__*/_react.default.createElement("td", null, /*#__PURE__*/_react.default.createElement(ConditionalWrap, {
          ...
          return /*#__PURE__*/_react.default.createElement("tr", {
            key: index
          }, _this.renderTh(item, acmscss), /*#__PURE__*/_react.default.createElement("td", null, /*#__PURE__*/_react.default.createElement("div", {
          ...
          return /*#__PURE__*/_react.default.createElement("tr", {
            key: index
          }, _this.renderTh(item, acmscss), /*#__PURE__*/_react.default.createElement("td", null, /*#__PURE__*/_react.default.createElement("select", {
            name: item.name,
            className: (0, _classnames.default)({
              'acms-admin-form-width-full': acmscss
            })
          ...
          return /*#__PURE__*/_react.default.createElement("tr", {
            key: index
          }, _this.renderTh(item), /*#__PURE__*/_react.default.createElement("td", null, item.option.map(function (option) {
            if (!option.label) {
              return null;
            }
            return /*#__PURE__*/_react.default.createElement("div", {
          ...
          return /*#__PURE__*/_react.default.createElement("tr", {
            key: index
          }, _this.renderTh(item), /*#__PURE__*/_react.default.createElement("td", {
            className: (0, _classnames.default)({
          ...
          return /*#__PURE__*/_react.default.createElement("tr", {
            key: index
          }, _this.renderTh(item, acmscss), /*#__PURE__*/_react.default.createElement("td", null, preview ? null : "<!-- BEGIN ".concat(item.name, "@path:veil -->"), /*#__PURE__*/_react.default.createElement("input", {
            type: "hidden",
            name: "".concat(item.name, "@old"),
            value: "{".concat(item.name, "@path}")
          }), /*#__PURE__*/_react.default.createElement("input", {
