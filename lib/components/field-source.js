...
var _section = _interopRequireDefault(require("./input/section"));
...
function _isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); } // import Section from './section';
...
(0, _defineProperty2.default)(FieldSource, "Section", function (_ref) {
  ...
  return tag === "section" && /*#__PURE__*/_react.default.createElement(_section.default, rest);
});
(0, _defineProperty2.default)(FieldSource, "Table", function (_ref2) {
  var tag = _ref2.tag,
    rest = (0, _objectWithoutProperties2.default)(_ref2, _excluded3);
  return tag === "table" && /*#__PURE__*/_react.default.createElement(_table.default, rest);
});
