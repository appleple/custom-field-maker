  ...
  (0, _createClass3.default)(Base, [{
    ...
    value: function renderMediaOption() {
      ...
      var _state8 = this.state,
          mediaType = _state8.mediaType,
          useDropArea = _state8.useDropArea,
          useFocusImage = _state8.useFocusImage,
          dropAreaWidth = _state8.dropAreaWidth,
          dropAreaHeight = _state8.dropAreaHeight,
          focusImageWidth = _state8.focusImageWidth,
          focusImageHeight = _state8.focusImageHeight;
    ...
    value: function renderFile() {
      ...
      var _state9 = this.state,
          extension = _state9.extension,
          fileName = _state9.fileName,
          fileNameMethod = _state9.fileNameMethod;
