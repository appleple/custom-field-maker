  ...
  (0, _createClass3.default)(Base, [{
    ...
    value: function typeSelectRender() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'option',
          { value: 'lite-editor' },
          '\u30A4\u30F3\u30E9\u30A4\u30F3\u30A8\u30C7\u30A3\u30BF\u30FC\uFF08LiteEditor\uFF09'
        ),
        _react2.default.createElement(
          'option',
          { value: 'paper-editor' },
          '\u30EA\u30C3\u30C1\u30A8\u30C7\u30A3\u30BF\u30FC\uFF08PaperEditor\uFF09'
        ),
        _react2.default.createElement(
          'option',
          { value: 'table' },
    ...
    value: function renderValidator() {
      ...
      return _react2.default.createElement(
        ...
        openValidator && _react2.default.createElement(
          ...
          showValidator && _react2.default.createElement(
            'table',
            { className: 'acms-admin-table customFieldOptionTable' },
            _react2.default.createElement(
              'tr',
    ...
    value: function renderRichEditorOption() {
      ...
      var _state8 = this.state,
          useExpand = _state8.useExpand,
          startHeadingLevel = _state8.startHeadingLevel,
          endHeadingLevel = _state8.endHeadingLevel;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'p',
          { className: 'acms-admin-form-checkbox' },
          _react2.default.createElement('input', { type: 'checkbox', onChange: this.updateState.bind(this, 'useExpand', !useExpand), checked: useExpand, id: 'expand-checkbox' }),
          _react2.default.createElement(
            'label',
        ...
        _react2.default.createElement(
          ...
          null,
          '\u958B\u59CB\u898B\u51FA\u3057\u30EC\u30D9\u30EB',
          _react2.default.createElement('span', { style: { display: 'inline-block', width: '5px', height: '1px' } }),
          ...
          _react2.default.createElement('span', { style: { display: 'inline-block', width: '15px', height: '1px' } }),
          '\u7D42\u4E86\u898B\u51FA\u3057\u30EC\u30D9\u30EB',
          _react2.default.createElement('span', { style: { display: 'inline-block', width: '5px', height: '1px' } }),
          _react2.default.createElement('input', {
            type: 'text',
    ...
    value: function renderMediaOption() {
      ...
      var _state9 = this.state,
          mediaType = _state9.mediaType,
          useDropArea = _state9.useDropArea,
          useFocusImage = _state9.useFocusImage,
          dropAreaWidth = _state9.dropAreaWidth,
          dropAreaHeight = _state9.dropAreaHeight,
          focusImageWidth = _state9.focusImageWidth,
          focusImageHeight = _state9.focusImageHeight;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('input', { type: 'checkbox', onChange: this.updateState.bind(this, 'mediaType', 'all'), checked: mediaType === 'all', id: 'media-type-all-radio' }),
          _react2.default.createElement(
            'label',
        ...
        _react2.default.createElement(
          'p',
          { className: 'acms-admin-form-radio' },
          _react2.default.createElement('input', { type: 'checkbox', onChange: this.updateState.bind(this, 'mediaType', 'image'), checked: mediaType === 'image', id: 'media-type-image-radio' }),
          _react2.default.createElement(
            'label',
        ...
        _react2.default.createElement(
          'p',
          { className: 'acms-admin-form-radio' },
          _react2.default.createElement('input', { type: 'checkbox', onChange: this.updateState.bind(this, 'mediaType', 'file'), checked: mediaType === 'file', id: 'media-type-file-radio' }),
          _react2.default.createElement(
            'label',
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement('input', {
              type: 'checkbox', onChange: function onChange() {
                if (useDropArea) {
          ...
          useDropArea && _react2.default.createElement(
            'div',
            null,
            '\u5E45 ',
            _react2.default.createElement('input', { type: 'text', defaultValue: dropAreaWidth }),
            ' px',
            _react2.default.createElement('span', { style: { display: 'inline-block', width: '15px', height: '1px' } }),
            '\u9AD8\u3055 ',
            _react2.default.createElement('input', { type: 'text', defaultValue: dropAreaHeight }),
            ' px'
          )
        ),
        _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          useFocusImage && _react2.default.createElement(
            'div',
            null,
            '\u5E45 ',
            _react2.default.createElement('input', { type: 'text', defaultValue: focusImageWidth }),
            ' px',
            _react2.default.createElement('span', { style: { display: 'inline-block', width: '15px', height: '1px' } }),
            '\u9AD8\u3055 ',
            _react2.default.createElement('input', { type: 'text', defaultValue: focusImageHeight }),
            ' px'
          )
        )
      );
    ...
    value: function renderFile() {
      ...
      var _state10 = this.state,
          extension = _state10.extension,
          fileName = _state10.fileName,
          fileNameMethod = _state10.fileNameMethod;
