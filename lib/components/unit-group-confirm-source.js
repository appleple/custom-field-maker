  ...
  (0, _createClass3.default)(UnitGroupConfirmSource, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'table',
          { className: (0, _classnames2.default)({ 'adminTable acms-admin-table-admin-edit acms-admin-table-admin-edit-bordered': acmscss }) },
                    ...
                    return _this2.wrapTable(_react2.default.createElement(
                      ...
                      item.mediaType !== 'file' && _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                          ...
                          !item.useFocusImage && _react2.default.createElement('img', { alt: '{' + item.name + '@alt}', src: '%{MEDIA_ARCHIVES_DIR}{' + item.name + '@path}' }),
                          '<!-- BEGIN_IF [{' + item.name + '@link}/nem] -->'
                        ),
                        '<!-- END_IF -->'
                      ),
