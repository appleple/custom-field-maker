...
export const MakerContext = createContext({
  ...
  addCustomfield: (_newCustomfield: unknown) => {},
  addCustomunit: (_newCustomunit: unknown) => {},
  setGroupTitleName: (_title: string, _name: string) => {},
  addGroupItem: (_newGroupItem: unknown) => {},
  setUnitGroupTitleName: (_title: string, _name: string) => {},
  addUnitGroupItem: (_newGroupItem: unknown) => {},
  clearCustomfield: () => {},
  clearGroup: () => {},
  clearGroupItem: () => {},
  clearCustomunit: () => {},
  ...
  setEditMode: (_editMode: string) => {},
  setTag: (_tag: string) => {},
  setAcmscss: (_acmscss: boolean) => {},
  setJsValidator: (_jsValidator: boolean) => {},
  setDirection: (_direction: string) => {},
  setEscapeSequence: (_escapeSequence: boolean) => {},
  setCopied: (_copied: boolean) => {},
  undo: (_target: string) => {},
  redo: (_target: string) => {},
});
