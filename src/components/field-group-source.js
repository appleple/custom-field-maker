            ...
            <Fragment>
              ...
              {jsValidator && (
                <div
                  ...
                  className={`validator-result-${classSuffix}`}
                >
            ...
            <thead className={classnames({ 'acms-admin-hide-sp': acmscss })}>
              <tr>
                ...
                {direction === 'horizontal' && (
                  <Fragment>
                    {groupitems.map((item) => (
                      <th className={classnames({ 'acms-admin-table-left': acmscss })}>
                        {item.title}
                        {item.tooltip && (
                    ...
                    if (item.type === 'text') {
                      ...
                      return this.wrapTable(
                        <td>
                          ...
                          {item.extension && (
                            <input type="hidden" name={`${item.name}@extension[]`} value={item.extension} />
                          )}
                      ...
                      return this.wrapTable(
                        <td className={classnames({ 'js-img_resize_cf': item.resize })}>
                          ...
                          {item.tinySize && (
                            <input type="hidden" name={`${item.name}@${item.tiny}[]`} value={item.tinySize} />
                          )}
                          {item.largeSize && (
                            <input type="hidden" name={`${item.name}@${item.large}[]`} value={item.largeSize} />
                          )}
                          {item.square && (
                            <input type="hidden" name={`${item.name}@${item.square}[]`} value={item.squareSize} />
                          )}
                          {this.renderValidator(item, acmscss, false)}
                        </td>,
                        item.title
                            ...
                            <Fragment>
                              <div>
                                ...
                                <ConditionalWrap
                                  ...
                                  wrap={(children) => (
                                    <a href={`%{MEDIA_ARCHIVES_DIR}{${item.name}@path}`}>{children}</a>
                                  )}
                                >
                                  <img
                              ...
                              <div className={classnames({ 'acms-admin-margin-top-mini': acmscss })}>
                                ...
                                <button
                                  type="button"
                                  className={classnames('js-remove', {
                      ...
                      if (item.type === 'text') {
                        ...
                        return this.wrapTable(
                          <td className={classnames({ 'js-img_resize_cf': item.resize })}>
                            ...
                            <input type="file" name={`${item.name}[]`} style={style} />
                            <br />
                            {item.alt && (
                              <Fragment>
                                代替テキスト:
                                <input type="text" name={`${item.name}@alt[]`} value="" size="40" />
                              </Fragment>
                            )}
                            {item.normalSize && (
                              <input type="hidden" name={`${item.name}@${item.normal}[]`} value={item.normalSize} />
                            ...
                            {!item.useDropArea && (
                              <Fragment>
                                ...
                                <div className="acms-admin-margin-top-mini">
                                  ...
                                  <button
                                    type="button"
                                    className={classnames('js-edit', { 'acms-admin-btn': acmscss })}
                                  >
                                    メディアを編集
                                  </button>
                                  <button
