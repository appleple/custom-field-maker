...
>>>>>>> 8348c4a (preview の変更が入力ソースに反映されない問題の修正)
        ...
        <p>
          <button className="acms-admin-btn" onClick={this.addOption.bind(this)}>
            追加
          </button>
        </p>
      </div>
        ...
        <span className="customFieldUseSnippet">
          <label className="customFieldUseSnippetLabel" style={{ marginRight: '5px' }}>
            <input
              ...
              value="true"
              onChange={() => {
                this.updateState('useSnippet', !useSnippet);
              }}
            />
...
=======
  ...
  // renderBasic() {
  //   const { title, name, tooltip, placeholder } = this.state;
  //   return (
  //     <table className="adminTable acms-admin-table-admin-edit customFieldBasicTable customFieldBasicTableFirst">
  //       <tbody>
  //         <tr>
  ...
  //               value={placeholder}
  //               onChange={e => {
  //                 this.updateState('placeholder', e.target.value);
  //               }}
  //               className="acms-admin-form-width-full"
...
>>>>>>> 8348c4a (preview の変更が入力ソースに反映されない問題の修正)
                ...
                placeholder="例）rs"
              />
              <button className="acms-admin-btn" onClick={this.updateState.bind(this, 'openConverter', true)}>
                コンバーター参照
              </button>
            </p>
            {showValidator && (
...
<<<<<<< HEAD
                <tbody>
                  <tr>
                    <th>
                      入力チェック
                      <i className="acms-admin-icon-tooltip" data-tip data-tooltip-id="validate-tip" />
                      <Tooltip
                        id="validate-tip"
                        place="top"
                        variant="dark"
                    ...
                    <th>
                      値
                      <i className="acms-admin-icon-tooltip" data-tip data-tooltip-id="validate-value-tip" />
                      <Tooltip
                    ...
                    <th>
                      メッセージ
                      <i className="acms-admin-icon-tooltip" data-tip data-tooltip-id="validate-message-tip" />
                      <Tooltip
...
>>>>>>> 8348c4a (preview の変更が入力ソースに反映されない問題の修正)
            ...
            {showValidator && (
              <p>
                <button onClick={this.addValidator.bind(this)} className="acms-admin-btn">
                  追加
                </button>
              </p>
            )}
...
<<<<<<< HEAD
            ...
            <th className="acms-admin-table-left">
              large画像生成
              <i className="acms-admin-icon-tooltip" data-tip data-tooltip-id="image-large-size-tip" />
              <Tooltip
                id="image-size-tip"
                place="top"
                variant="dark"
            ...
            <th className="acms-admin-table-left">
              tiny画像生成
              <i className="acms-admin-icon-tooltip" data-tip data-tooltip-id="image-tiny-size-tip" />
              <Tooltip
            ...
            <th className="acms-admin-table-left">
              square画像生成
              <i className="acms-admin-icon-tooltip" data-tip data-tooltip-id="image-square-size-tip" />
              <Tooltip
                id="image-tiny-size-tip"
                place="top"
                variant="dark"
...
=======
  ...
  //         {useDropArea && (
  //           <div>
  //             幅 <input type="text" value={dropAreaWidth} /> px
  //             <span style={{ display: 'inline-block', width: '15px', height: '1px' }} />
  //             高さ <input type="text" value={dropAreaHeight} /> px
  //           </div>
  //         )}
  //       </div>
  //       <p style={{ marginBottom: '5px' }}>トリミング</p>
